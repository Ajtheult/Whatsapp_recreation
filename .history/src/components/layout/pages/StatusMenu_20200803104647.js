    ...
    <div>
      ...
      <Link to="#write">
        <button className="btn-floating btn-small waves-effect waves-light green right move_message_icon_in_status_menu_small pulse">
          <i className="fas fa-pen z-depth-3" />
        </button>
      </Link>
      <Link to="#post_status">
        <button className="btn-floating btn-large waves-effect waves-light green right move_message_icon_in_status_menu_big pulse">
