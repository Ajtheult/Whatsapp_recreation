  ...
  return (
    <div>
      ...
      <h6 className="move_message_icon_in_chat_menu">
        <Link to="#contacts">
          <button className="btn-floating btn-large waves-effect waves-light green right move_contact_icon_abit_up_call pulse disabled_btn_bottom">
