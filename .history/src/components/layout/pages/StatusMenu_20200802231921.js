...
const ChatMenu = () => {
  ...
  return (
    <div>
      ...
      <h6 className="move_message_icon_in_status_menu">
        <Link to="#contacts">
          <button className="btn-floating btn-small waves-effect waves-light teal right move_message_icon_in_status_menu_small">
