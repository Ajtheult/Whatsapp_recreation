...
const ContactMenu = () => {
  const [contacts] = useState([
    ...
    {
      img:
        "https://images.unsplash.com/photo-1541963463532-d68292c34b19?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80",
      name: "Cay-lynn🦄",
      message: "🍂💜",
    },
    {
    ...
    },
    {
      ...
      name: "Viata🙈",
      message: "You are worthy before not because.",
    },
    {
      img:
  ...
  return (
    <div>
      <ContactNav />
      <div className="row move_group_contact">
        <div className="col s3 ">
          <button className="btn-floating btn-large waves-effect waves-light red contact_menu_icons">
            {" "}
            <i className="fas fa-user-friends teal "></i>
          </button>
        </div>
      ...
      <div className="row move_group_contact">
        <div className="col s3">
          <button className="btn-floating btn-large waves-effect waves-light red contact_menu_icons">
            {" "}
            <i className="fas fa-user-plus teal"></i>
          </button>
        </div>
        <div className="col s9 chat_menu_text">
          <h6>New contact</h6>
