  ...
  render() {
    return (
      <div>
        ...
        <button
          class="waves-effect waves-light btn modal-trigger move_this_modal"
          href="#modal1"
        >
          Whatsapp recreation launch
        </button>
        ...
        <div id="modal1" class="modal">
          <div class="modal-content">
            <h5>
              ...
              this press "launch app". <br /> If you don't then press "I don't
              understand".
            </h5>
          </div>
          <div class="modal-footer">
            <button class="modal-close waves-effect waves-green btn-large left red">
              I don't understand
            </button>
